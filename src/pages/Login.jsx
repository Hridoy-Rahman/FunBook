...
import { TextInputField, CustomButton, Loading } from "../components/index";
    ...
    <div className="bg-bgColor w-full flex items-center justify-center p-6">
      <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl">
        ...
        <div className="w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center ">
          ...
          <span className="text-2xl mt-2 text-ascent-2">Welcome back</span>
          ...
          >
            ...
            <Link
              to="/reset-password"
              className="text-sm text-right text-blue font-semibold my-2"
            >
              Forgot Password?
            </Link>
